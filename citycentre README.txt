...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=citycentre&box=-1.556036,55.010870,-1.681363,54.939005
...
-----------
  ...
  * citycentre Height Map (ASTER 30m).png
  ...
  * citycentre Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * citycentre Height Map (SRTM30 Plus).png
